...
Date the file was submitted : 11.03.2020

The purpose of the game program is to form and declare the best word using a bag of letters given as input. Not every given letter in the bag is distinct;
some letters may be present more than once. The project program forms a word.
...
METHOD: 
FUNCTION from_bag() : 
This function checks whether a given word can be formed from given bag of letters. 
